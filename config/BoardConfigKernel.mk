# Copyright (C) 2018-2023 The Project-Xtended
#
...
ifneq ($(KERNEL_NO_GCC), true)
    ...
    TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-xtended/$(HOST_PREBUILT_TAG)/bin:$(TARGET_KERNEL_CLANG_PATH)/bin:$$PATH
endif
